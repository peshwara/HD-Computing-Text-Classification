...
int main() {
	...
	DIR *dir;
	struct dirent *ent;
	char folder_name[] = "C:\\Users\\poorn\\Desktop\\testing\\training";
	string testing_data_file = "C:\\Users\\poorn\\Desktop\\testing\\testing.txt";
	//generateItemMemory();
			...
			if (str.size() > 4) {
				if (str.substr(str.size() - 4, 100).compare(".txt") == 0) {
					...
					for (i = path.begin(); i != path.end(); ++i) {
						...
						//splitText_continuous(NGRAM,strWords[1]);
